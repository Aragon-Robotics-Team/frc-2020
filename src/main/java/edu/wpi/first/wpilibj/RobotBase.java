    ...
    private static <T extends RobotBase> void runRobot(Supplier<T> robotSupplier) {
        ...
        try {
            ...
            DriverStation.reportError(
                    "Unhandled exception instantiating robot " + robotName + " " + throwable.toString(), elements);
        ...
        try {
            ...
            if (!suppressExitWarning) {
                ...
                DriverStation.reportWarning("Robots should not quit, but yours did!", false);
                if (errorOnExit) {
                    DriverStation.reportError("The startCompetition() method (or methods called by it) should have "
