...
public class AddressableLED implements AutoCloseable {
     ...
     *
     * <p>
     * Calling this is an expensive call, so its best to call it once, then just
     * update data.
     *
    ...
    public void setBitTiming(int lowTime0NanoSeconds, int highTime0NanoSeconds, int lowTime1NanoSeconds,
        ...
        AddressableLEDJNI.setBitTiming(m_handle, lowTime0NanoSeconds, highTime0NanoSeconds, lowTime1NanoSeconds,
