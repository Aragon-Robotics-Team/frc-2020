 ...
 * driving.
 *
 * @deprecated Use {@link edu.wpi.first.wpilibj.drive.DifferentialDrive} or
 *             {@link edu.wpi.first.wpilibj.drive.MecanumDrive} classes instead.
 */
@Deprecated
...
public class RobotDrive extends MotorSafety implements AutoCloseable {
    ...
    /**
     * Constructor for RobotDrive with 2 motors specified with channel numbers. Set
     * up parameters for a two wheel drive system where the left and right motor pwm
     * channels are specified in the call. This call assumes Talons for controlling
     * the motors.
     *
    ...
    /**
     * Constructor for RobotDrive with 4 motors specified with channel numbers. Set
     * up parameters for a four wheel drive system where all four motor pwm channels
     * are specified in the call. This call assumes Talons for controlling the
     * motors.
     *
     ...
     *                        Set curve = e^(-r/w) to get a turn radius r for
     *                        wheelbase w of your robot. Conversely, turn radius r =
     *                        -ln(curve)*w for a given value of curve and wheelbase
     *                        w.
     */
     ...
     * object. The calculated values will be squared to decrease sensitivity at low
     * speeds.
     *
     ...
     * right sides of the robot. The calculated values will be squared to decrease
    ...
    /**
     * Provide tank steering using the stored robot configuration. This function
     * lets you directly provide joystick values from any source. The calculated
     ...
     * value. (Should add more information here regarding the way that arcade drive
     * works.)
     *
     * @param stick         The joystick to use for Arcade single-stick driving. The
     *                      Y-axis will be selected for forwards/backwards and the
     ...
     * class assumes the Y axis for the move value and the X axis for the rotate
     * value. (Should add more information here regarding the way that arcade drive
     * works.) The calculated values will be squared to decrease sensitivity at low
     * speeds.
     *
    ...
    /**
     * Arcade drive implements single stick driving. Given two joystick instances
     * and two axis, compute the values to send to either two or four motors. The
    ...
    /**
     * Arcade drive implements single stick driving. This function lets you directly
     * provide joystick values from any source. The calculated values will be
     ...
     *                  [-1.0..1.0]
     * @param direction The angle the robot should drive in degrees. The direction
     ...
     *                  maginitude are independent of the rotation rate.
     * @param rotation  The rate of rotation for the robot that is completely
