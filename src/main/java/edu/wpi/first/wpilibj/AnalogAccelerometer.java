...
public class AnalogAccelerometer implements PIDSource, Sendable, AutoCloseable {
    ...
    private void initAccelerometer() {
        HAL.report(1, m_analogChannel.getChannel() + 1);
    ...
    /**
     * Create a new instance of Accelerometer from an existing AnalogChannel. Make a
     * new instance of accelerometer given an AnalogChannel. This is particularly
     * useful if the port is going to be read as an analog channel as well as
     * through the Accelerometer class.
     *
