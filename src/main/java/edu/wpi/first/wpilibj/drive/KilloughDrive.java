...
public class KilloughDrive extends RobotDriveBase implements Sendable, AutoCloseable {
    ...
    public KilloughDrive(SpeedController leftMotor, SpeedController rightMotor, SpeedController backMotor) {
        this(leftMotor, rightMotor, backMotor, kDefaultLeftMotorAngle, kDefaultRightMotorAngle, kDefaultBackMotorAngle);
    }
     ...
     */
    public KilloughDrive(SpeedController leftMotor, SpeedController rightMotor, SpeedController backMotor,
            double leftMotorAngle, double rightMotorAngle, double backMotorAngle) {
    ...
    private void verify(SpeedController leftMotor, SpeedController rightMotor, SpeedController backMotor) {
