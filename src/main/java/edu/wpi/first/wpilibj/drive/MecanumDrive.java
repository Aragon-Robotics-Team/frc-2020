...
public class MecanumDrive extends RobotDriveBase implements Sendable, AutoCloseable {
     ...
     */
    public MecanumDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor, SpeedController frontRightMotor,
     ...
     * {@code
     * NullPointerException("frontLeftMotor, rearRightMotor")}, to give as much
    ...
    private void verify(SpeedController frontLeft, SpeedController rearLeft, SpeedController frontRight,
            SpeedController rearRightMotor) {
    ...
    public void driveCartesian(double ySpeed, double xSpeed, double zRotation, double gyroAngle) {
        ...
        m_frontRightMotor.set(wheelSpeeds[MotorType.kFrontRight.value] * m_maxOutput * m_rightSideInvertMultiplier);
        m_rearLeftMotor.set(wheelSpeeds[MotorType.kRearLeft.value] * m_maxOutput);
        m_rearRightMotor.set(wheelSpeeds[MotorType.kRearRight.value] * m_maxOutput * m_rightSideInvertMultiplier);
